...
class Example:
    ...
    def step(self):
        ...
        # step sees a body_q that advanced by exactly sim_dt.  With backward
        ...
        for _ in range(self.sim_substeps):
            ...
            wp.synchronize()
            self._t_robot += time.perf_counter() - t0

            self.state_0, self.state_1 = self.state_1, self.state_0

            # gap limits projection to particles within one voxel of the scoop
        ...
        if self._t_count >= self._t_print_every:
            n  = self._t_count
            s  = self.sim_substeps
            tf = self._t_frame   / n * 1000
            tr = self._t_robot   / n * 1000 / s
            tp = self._t_project / n * 1000 / s
            tm = self._t_mpm     / n * 1000 / s
            print(
    ...
    def create_parser():
        ...
        parser.add_argument(
            ...
            default="backward",
            choices=["forward", "backward", "instantaneous", "finite_difference"],
        )
